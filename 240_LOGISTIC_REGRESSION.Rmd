##<a name="24_LOGISTIC_REGRESSION" style="pointer-events: none; cursor: default;" ><font color="red"> 2.4. Logistic Regression</font></a>
...
Once this is achieved, the classification is simply derived based on that probability value.
