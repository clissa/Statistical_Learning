...
plot
```
Notice that the two classes does not appear very separated. Probably, the quite decent performances of the model are due to the fact that the dataset is unbalanced and that the model correctly classifies the most represented categories. i.e. observations of class 1.
